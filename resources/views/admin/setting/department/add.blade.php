                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('department') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="department" id="department" class="form-control" value="{{ old('department') }}" placeholder="{{ __('Enter department name..') }}">
                            ...
                            <!-- /.form-group -->
                            <label for="publication_status">{{ __('Status') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('department_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea text-description" name="department_description" id="department_description" placeholder="{{ __('Enter description..') }}">{{ old('department_description') }}</textarea>
                                @if ($errors->has('department'))
                                <span class="help-block">
