                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('designation') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="designation" id="designation" class="form-control" value="{{ old('designation') }}" placeholder="{{ __('Enter designation title..') }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('designation_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea text-description" name="designation_description" id="designation_description" placeholder="{{ __('Enter description..') }}">{{ old('designation_description') }}</textarea>
                                @if ($errors->has('designation'))
                                <span class="help-block">
