...
<div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="col-md-3">
                    <a href="{{ url('/clients/create') }}" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> {{ __('Add Customer') }}</a>
                </div>
                <div class="col-md-3">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                   <a href="{{ url('/clients/edit/' . $client['id']) }}"><i class="icon fa fa-edit"></i> {{ __('Edit') }}</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
