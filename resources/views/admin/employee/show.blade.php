...
<div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a>{{ __('People') }}</a></li>
            <li><a href="{{ url('/employees') }}">{{ __('Team') }}</a></li>
...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
            <a href="{{ url('/employees') }}" class="btn btn-primary btn-flat"><i class="fa fa-arrow-left"></i> {{ __('Back') }}</a>
            <hr>
            ...
            <div class="btn-group btn-group-justified">
                ...
                <div class="btn-group">
                    <a href="{{ url('/employees/deactive/' . $employee->id)}}" class="tip btn btn-success btn-flat" data-toggle="tooltip" data-original-title="Click to deactive">
                ...
                @else
                <div class="btn-group">
                    <a href="{{ url('/employees/active/' . $employee->id)}}" class="tip btn btn-warning btn-flat" data-toggle="tooltip" data-original-title="Click to active">
                ...
                <div class="btn-group">
                    <a href="{{ url('/employees/edit/' . $employee->id) }}" class="tip btn btn-warning tip btn-flat" title="" data-original-title="Edit Product">
                        <i class="fa fa-edit"></i>
                        <span class="hidden-sm hidden-xs"> {{ __('Edit') }}</span>
                    </a>
                </div>
                <div class="btn-group">
                    <a href="{{ url('/employees/delete/' . $employee->id) }}" class="tip btn btn-danger btn-flat" data-toggle="tooltip" data-original-title="Click to delete" onclick="return confirm('Are you sure to delete this ?');">
                        <i class="fa fa-arrow-up"></i>
