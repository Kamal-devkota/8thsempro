                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <label for="avatar">{{ __('Profile Picture') }} <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                ...
                                <div
                                    ...
                                    <input type="text" name="permanent_address" id="permanent_address"
                                        class="form-control" value="{{ $user['permanent_address'] }}"
                                        placeholder="{{ __('Enter contact no..') }}">
                                ...
                                <div
                                    class="form-group{{ $errors->has('date_of_birth') ? ' has-error' : '' }} has-feedback">
