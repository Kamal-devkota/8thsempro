    ...
    <div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a>{{ __('HRM') }}</a></li>
                <li><a href="{{ url('/hrm/expense/manage-expense') }}">{{ __('Add new expeses') }}</a></li>
        ...
        <section class="content">
            ...
            <div class="box box-default">
                ...
                <!-- /.box-header -->
                <form action="{{ url('/hrm/expense/store') }}" method="post" name="add_form_expense">
                    {{ csrf_field() }}
                    <div class="box-body">
                        <div class="row">
                            <!-- Notification Box -->
                            ...
                            <div class="col-md-6">
                                ...
                                <label for="balance_amount">{{ __('Expense Date') }} <span
                                ...
                                <label for="employee_id">{{ __('Expense Purpose') }} <span
                                        class="text-danger">*</span></label>
                                <div
                                ...
                                <label for="balance_amount">{{ __('Expense amount') }} <span
                                        class="text-danger">*</span></label>
                                <div
                                    class="form-group{{ $errors->has('balance_amount') ? ' has-error' : '' }} has-feedback">
                                    <input type="text" name="exp_amount" id="balance_amount" class="form-control"
                                        value="{{ old('balance_amount') }}"
                                        placeholder="{{ __('Enter Balance amount..') }}">
                            ...
                            <!-- /.col -->
                            <div class="col-md-12">
                                <label for="remarks_if_any">{{ __('Remarks, if any') }} <span
                                        class="text-danger"></span></label>
                                <div
                                    class="form-group{{ $errors->has('remarks_if_any') ? ' has-error' : '' }} has-feedback">
