...
<div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <div  class="col-md-3">
                    <a href="{{ url('/hrm/expense/add-expense') }}" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> {{ __('add new accounts') }}</a>
                </div>
                <div  class="col-md-3">
                ...
                <table  class="table table-bordered table-striped">
                    ...
                    <tbody id="myTable">
                        ...
                        <tr>
                            ...
                            <td><a href="{{url('/hrm/expense/payslip/'.$expense->id)}}" class="btn btn-primary">Pay Slip</a></td>
