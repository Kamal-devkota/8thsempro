                        ...
                        <table class="table border_less">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>: {{\App\Models\User::find($expense->employee_id)->name}}</td>
                                </tr>
                                <tr>
         ...
         @endforeach 
            <div class="row">
             ...
             <div class="myprint">
                    ...
                    <a href="{{url('hrm/expense/manage-expense')}}"><button class="btn btn-primary"><i class="fa fa-download"></i> {{ __('Back') }}</button></a>
