                ...
                <form action="{{ url('/hrm/leave_application/store') }}" method="post" name="add_form_leave_application">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label for="leave_category">{{ __('Leave Category ') }}<span
                                ...
                                <label for="last_leave_period">{{ __('Period of Last Leave') }} <span
                                        class="text-danger"></span></label>
                                <div
                                    class="form-group{{ $errors->has('last_leave_period') ? ' has-error' : '' }} has-feedback">
                                    <input type="text" name="last_leave_period" id="last_leave_period"
                                        class="form-control" value="{{ old('last_leave_period') }}"
                                        placeholder="{{ __('Enter Period of Last Leave..') }}">
                                ...
                                <label for="leave_category">{{ __('Category of Last Leave') }} <span
                                        class="text-danger"></span></label>
                                <div
                                    class="form-group{{ $errors->has('leave_category') ? ' has-error' : '' }} has-feedback">
                                ...
                                <label for="leave_address">{{ __('Leave Address') }} <span
                                        class="text-danger"></span></label>
                                <div
                                    class="form-group{{ $errors->has('leave_address') ? ' has-error' : '' }} has-feedback">
                            ...
                            <div class="col-md-12">
                                ...
                                <label for="during_leave">{{ __('Bottom Section') }} <span
                                        class="text-danger"></span></label>
                                <div
                                    class="form-group{{ $errors->has('during_leave') ? ' has-error' : '' }} has-feedback">
                                    <input type="text" name="during_leave" id="during_leave" class="form-control"
                                        value="{{ old('during_leave') }}"
                                        placeholder="{{ __('Therefore, I request you to kindly grant me leave for .. Enter here') }}">
                    ...
                    <div class="box-footer">
                        <a href="{{ url('/hrm/leave_application') }}" class="btn btn-danger btn-flat"><i
