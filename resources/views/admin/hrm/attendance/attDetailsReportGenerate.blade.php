            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal" action="{{ url('/hrm/attendance/details/report/all') }}"
                            method="get">
                                ...
                                <div class="col-sm-3">
                                    <select name="emp_id" id="user_id" class="form-control">
                                        ...
                                        @foreach ($employees as $employee)
                                            <option value="{{ $employee['id'] }}"><strong>{{ $employee['name'] }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-10">
                                    <button type="submit" class="btn btn-primary btn-flat"><i
                                            class="fa fa-arrow-right"></i> {{ __('View Attendence Statement') }}</button>
                                </div>
                            </div>
                            <!-- /.end group -->
                        </form>
