        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">{{ __('Attendances Taken') }} </h3>
                </div>
                <div class="box-body">
                    <div class="col-md-12">
                                        ...
                                        @foreach ($attendances as $attendance)
                                            @if ($employee['id'] == $attendance['user_id'])
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <select name="leave_category_id[]"
                                                            id="leave_category_id_{{ $employee['id'] }}"
                                                            class="form-control">
                                                            <option selected value="0">{{ __('Select one') }}
                                                            </option>
                                                ...
                                                <script type="text/javascript">
                                                    document.forms['attendance_update_form'].elements['leave_category_id_{{ $employee['id'] }}'].value =
                                                        "{{ $attendance['leave_category_id'] }}";
                                                </script>
                                                <td>
                                                    <div class="form-group">
                                                        <input type="text" name="check_in[]"
                                                            value="{{ $attendance['check_in'] }}" class="form-control">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-group">
                            ...
                            <tfoot>
                                <tr>
                                    <td><button type="submit" class="btn btn-primary btn-flat pull-right"><i
                                                class="icon fa fa-edit"></i> {{ __('Update') }}</button></td>
                                </tr>
                            </tfoot>
                        </table>
                    </form>
