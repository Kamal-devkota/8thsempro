    ...
    <div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="btn-body">
                        <a href="{{ url('/hrm/attendance/details/report/go') }}" class="tip btn btn-primary btn-flat"><i
                                class="fa fa-plus"></i>{{ __('add new Attendance Statement') }} </a>
                    ...
                    <div class="st-center-body">
                        ...
                        <center><b>{{ date('F Y', strtotime($startdate)) }} to
                                {{ date('F Y', strtotime($enddate)) }}<br>
