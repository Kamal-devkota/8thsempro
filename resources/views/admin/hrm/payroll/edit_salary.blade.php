                            ...
                            <div class="box-body">
                                <div class="form-group{{ $errors->has('house_rent_allowance') ? ' has-error' : '' }}">
                                    ...
                                    <input type="number" name="house_rent_allowance"
                                        value="{{ $salary['house_rent_allowance'] }}" class="form-control"
                                ...
                                <div class="form-group{{ $errors->has('medical_allowance') ? ' has-error' : '' }}">
                                    ...
                                    <input type="number" name="medical_allowance"
                                        value="{{ $salary['medical_allowance'] }}" class="form-control"
                                ...
                                <div class="form-group{{ $errors->has('special_allowance') ? ' has-error' : '' }}">
                                    ...
                                    <input type="number" name="special_allowance"
                                        value="{{ $salary['special_allowance'] }}" class="form-control"
                                ...
                                <div
                                    ...
                                    <input type="number" name="provident_fund_contribution"
                                        ...
                                        placeholder="{{ __('Enter special allowance..') }}">
                                ...
                                <div class="form-group{{ $errors->has('other_allowance') ? ' has-error' : '' }}">
                                    ...
                                    <input type="number" name="other_allowance"
                                        value="{{ $salary['other_allowance'] }}" class="form-control"
                                        id="other_allowance" placeholder="{{ __('Enter other allowance..') }}">
                        ...
                        <div class="box box-warning">
                            ...
                            <div class="box-body">
                                <div class="form-group{{ $errors->has('tax_deduction') ? ' has-error' : '' }}">
                                    ...
                                    <input type="number" name="tax_deduction" value="{{ $salary['tax_deduction'] }}"
                                ...
                                <div
                                    ...
                                    <input type="number" name="provident_fund_deduction"
                                        value="{{ $salary['provident_fund_deduction'] }}" class="form-control"
                                        id="provident_fund_deduction" placeholder="{{ __('Enter tax deduction..') }}">
                                ...
                                <div class="form-group{{ $errors->has('other_deduction') ? ' has-error' : '' }}">
                                    ...
                                    <input type="number" name="other_deduction"
                                        value="{{ $salary['other_deduction'] }}" class="form-control"
                                        id="other_deduction" placeholder="{{ __('Enter other deduction..') }}">
                        ...
                        <div class="box box-danger">
                            ...
                            <div class="box-footer">
                                <button type="submit" class="btn btn-primary btn-flat pull-right"><i
                                        class="fa fa-edit"></i> {{ __('Update Details') }}</button>
                            </div>
                        </div>
                    </div>
                    <!-- /.end.col -->
