                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-3">
                                @if (!empty($salary['avatar']))
                                    <img src="{{ url('public/profile_picture/' . $salary['avatar']) }}"
                                        class="img-responsive img-thumbnail" width="250px">
                                @else
                                    <img src="{{ url('public/profile_picture/blank_profile_picture.png') }}"
                                        alt="blank_profile_picture" class="img-responsive img-thumbnail" width="160px">
                                @endif
                            </div>
                            <!-- /. end col -->
                        </div>
