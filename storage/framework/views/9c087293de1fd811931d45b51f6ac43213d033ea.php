            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal" action="<?php echo e(url('/hrm/attendance/details/report/all')); ?>"
                            method="get">
                                ...
                                <div class="col-sm-3">
                                    <select name="emp_id" id="user_id" class="form-control">
                                        ...
                                        <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($employee['id']); ?>"><strong><?php echo e($employee['name']); ?>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-10">
                                    <button type="submit" class="btn btn-primary btn-flat"><i
                                            class="fa fa-arrow-right"></i> <?php echo e(__('View Attendence Statement')); ?></button>
                                </div>
                            </div>
                            <!-- /.end group -->
                        </form>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/College/KarmaPatro/resources/views/admin/hrm/attendance/attDetailsReportGenerate.blade.php ENDPATH**/ ?>