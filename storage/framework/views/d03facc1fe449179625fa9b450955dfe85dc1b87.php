    ...
    <div class="box box-default">
      ...
      <form action="<?php echo e(url('setting/holidays/store')); ?>" method="post" name="holidays_add_form">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group<?php echo e($errors->has('holiday_name') ? ' has-error' : ''); ?> has-feedback">
                <input type="text" name="holiday_name" id="holiday_name" class="form-control" value="<?php echo e(old('holiday_name')); ?>" placeholder="<?php echo e(__('Enter event name..')); ?>">
            ...
            <div class="col-md-12">
              ...
              <div class="form-group<?php echo e($errors->has('description') ? ' has-error' : ''); ?> has-feedback">
                <textarea class="textarea text-description" name="description" id="description" placeholder="<?php echo e(__('Enter Holiday description..')); ?>"><?php echo e(old('description')); ?></textarea>
        ...
        <div class="box-footer">
          <a href="<?php echo e(url('setting/holidays')); ?>" class="btn btn-danger btn-flat"><i class="icon fa fa-close"></i> <?php echo e(__('Cancel')); ?></a>
          <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> <?php echo e(__('Add Holiday List')); ?></button>
        </div>
      </form>
    </div>
    <!-- /.box -->
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/College/KarmaPatro/resources/views/admin/setting/holiday/add-holidays.blade.php ENDPATH**/ ?>