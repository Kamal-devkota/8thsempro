    ...
    <div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo e(url('/hrm/expense/manage-expense')); ?>"><?php echo e(__('Add new expeses')); ?></a></li>
        ...
        <section class="content">
            ...
            <div class="box box-default">
                ...
                <!-- /.box-header -->
                <form action="<?php echo e(url('/hrm/expense/store')); ?>" method="post" name="add_form_expense">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <label for="balance_amount"><?php echo e(__('Expense Date')); ?> <span
                                ...
                                <label for="employee_id"><?php echo e(__('Expense Purpose')); ?> <span
                                        class="text-danger">*</span></label>
                                <div
                                    ...
                                    <select name="exp_purpose" class="form-control">
                                        ...
                                        <?php $expcats = \App\Models\ExpPurpose::all()->where('created_by', Auth::user()->id); ?>
                                ...
                                <label for="balance_amount"><?php echo e(__('Expense amount')); ?> <span
                                        class="text-danger">*</span></label>
                                <div
                                    class="form-group<?php echo e($errors->has('balance_amount') ? ' has-error' : ''); ?> has-feedback">
                                    <input type="text" name="exp_amount" id="balance_amount" class="form-control"
                                        value="<?php echo e(old('balance_amount')); ?>"
                                        placeholder="<?php echo e(__('Enter Balance amount..')); ?>">
                            ...
                            <!-- /.col -->
                            <div class="col-md-12">
                                <label for="remarks_if_any"><?php echo e(__('Remarks, if any')); ?> <span
                                        class="text-danger"></span></label>
                                <div
                                    class="form-group<?php echo e($errors->has('remarks_if_any') ? ' has-error' : ''); ?> has-feedback">
                                    <textarea class="textarea text-description" name="particular" placeholder="<?php echo e(__('Enter Purchased Details..')); ?>"><?php echo e(old('remarks_if_any')); ?></textarea>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/College/KarmaPatro/resources/views/admin/hrm/expense/add_expense.blade.php ENDPATH**/ ?>