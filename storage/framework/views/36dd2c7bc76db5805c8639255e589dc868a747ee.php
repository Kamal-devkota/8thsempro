...
<?php $__env->startSection('main_content'); ?>
    <div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
        ...
        <section class="content-header">
            <h1>
                <?php echo e(__('UPDATE ATTENDANCE')); ?>
        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title"><?php echo e(__('Attendances Taken')); ?> </h3>
                </div>
                <div class="box-body">
                    <div class="col-md-12">
                    ...
                    <form action="<?php echo e(url('/hrm/attendance/update')); ?>" name="attendance_update_form" method="post">
                        ...
                        <table class="table table-bordered table-striped">
                                        ...
                                        <?php $__currentLoopData = $attendances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($employee['id'] == $attendance['user_id']): ?>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <select name="leave_category_id[]"
                                                            id="leave_category_id_<?php echo e($employee['id']); ?>"
                                                            class="form-control">
                                                            <option selected value="0"><?php echo e(__('Select one')); ?>
                                                ...
                                                <script type="text/javascript">
                                                    document.forms['attendance_update_form'].elements['leave_category_id_<?php echo e($employee['id']); ?>'].value =
                                                        "<?php echo e($attendance['leave_category_id']); ?>";
                                                </script>
                                                <td>
                                                    <div class="form-group">
                                                        <input type="text" name="check_in[]"
                                                            value="<?php echo e($attendance['check_in']); ?>" class="form-control">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            <input type="text" name="check_out[]"
                                                                value="<?php echo e($attendance['check_out']); ?>"
                                                                class="form-control">
                                                        </div>
                                                    </div>
                                                </td>
                            ...
                            <tfoot>
                                <tr>
                                    <td><button type="submit" class="btn btn-primary btn-flat pull-right"><i
                                                class="icon fa fa-edit"></i> <?php echo e(__('Update')); ?></button></td>
                                </tr>
                            </tfoot>
                        </table>
                    </form>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/College/KarmaPatro/resources/views/admin/hrm/attendance/edit_attendance.blade.php ENDPATH**/ ?>