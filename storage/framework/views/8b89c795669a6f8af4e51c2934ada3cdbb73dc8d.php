                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo e($errors->has('designation') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="designation" id="designation" class="form-control" value="<?php echo e(old('designation')); ?>" placeholder="<?php echo e(__('Enter designation title..')); ?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group<?php echo e($errors->has('designation_description') ? ' has-error' : ''); ?> has-feedback">
                                <textarea class="textarea text-description" name="designation_description" id="designation_description" placeholder="<?php echo e(__('Enter description..')); ?>"><?php echo e(old('designation_description')); ?></textarea>
                                <?php if($errors->has('designation')): ?>
                                <span class="help-block">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/College/KarmaPatro/resources/views/admin/setting/designation/add.blade.php ENDPATH**/ ?>