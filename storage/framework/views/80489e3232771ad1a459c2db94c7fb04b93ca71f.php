    ...
    <div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="btn-body">
                        <a href="<?php echo e(url('/hrm/attendance/details/report/go')); ?>" class="tip btn btn-primary btn-flat"><i
                                class="fa fa-plus"></i><?php echo e(__('add new Attendance Statement')); ?> </a>

                        <form action="<?php echo e(url('/hrm/attendance/details/report/pdf')); ?>" method="get">
                    ...
                    <div class="st-left-body">
                        <h4>
                            ...
                            <?php $desig = \App\Models\Designation::find($designation)->designation; ?>
                    ...
                    <div class="st-center-body">
                        ...
                        <center><b><?php echo e(date('F Y', strtotime($startdate))); ?> to
                                <?php echo e(date('F Y', strtotime($enddate))); ?><br>
                                <?php $users = \App\Models\User::all()->where('employee_id', $empid);
                                foreach ($users as $user) {
                                    $empname = $user->name;
                                }
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/College/KarmaPatro/resources/views/admin/hrm/attendance/detailsAttendanceReport.blade.php ENDPATH**/ ?>