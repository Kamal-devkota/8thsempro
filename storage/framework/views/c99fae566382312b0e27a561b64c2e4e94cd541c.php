                            ...
                            <div class="col-md-6">
                                ...
                                <div
                                    ...
                                    <input type="text" name="contact_no_one" id="contact_no_one" class="form-control"
                                        value="<?php echo e($user['contact_no_one']); ?>"
                                ...
                                <label for="avatar"><?php echo e(__('Profile Picture')); ?> <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                ...
                                <div
                                    ...
                                    <input type="text" name="present_address" id="present_address" class="form-control"
                                        value="<?php echo e($user['present_address']); ?>"
                                        placeholder="<?php echo e(__('Enter contact no..')); ?>">
                                ...
                                <div
                                    ...
                                    <input type="text" name="permanent_address" id="permanent_address"
                                        class="form-control" value="<?php echo e($user['permanent_address']); ?>"
                                        placeholder="<?php echo e(__('Enter contact no..')); ?>">
                                ...
                                <div
                                    class="form-group<?php echo e($errors->has('date_of_birth') ? ' has-error' : ''); ?> has-feedback">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/College/KarmaPatro/resources/views/admin/profile/user_profile.blade.php ENDPATH**/ ?>