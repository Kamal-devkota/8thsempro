                            ...
                            <tbody id="myTable">
                                ...
                                <?php $__currentLoopData = $employee_awords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee_aword): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e(\Illuminate\Support\Str::limit($employee_aword['description'], 65)); ?></td>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/College/KarmaPatro/resources/views/admin/hrm/employee_awards/manage_employee_award.blade.php ENDPATH**/ ?>