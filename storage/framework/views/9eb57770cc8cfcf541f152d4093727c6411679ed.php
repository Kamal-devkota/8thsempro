                ...
                <div class="box-body">
                    ...
                    <div class="col-md-6">
                        <a href="<?php echo e(url('/setting/departments/create')); ?>" class="btn btn-primary btn-flat"><i
                                class="fa fa-plus"></i> <?php echo e(__('Add NOC')); ?></a>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12 table-responsive">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody id="myTable">
                                <?php $nocs = \App\Models\Noc::all()->where('category', 1); ?>
                                <?php ($sl = 1); ?>
                                <?php $__currentLoopData = $nocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $noc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo e(url('/hrm/noc/generate/' . $noc->id)); ?>"><i
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/College/KarmaPatro/resources/views/admin/hrm/certificate/nocList.blade.php ENDPATH**/ ?>