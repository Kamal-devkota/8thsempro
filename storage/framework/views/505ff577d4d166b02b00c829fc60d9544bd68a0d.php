                            ...
                            <tbody id="myTable">
                                ...
                                <?php $__currentLoopData = $award_categorys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $award_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a
                                                href="<?php echo e(url('/setting/award_categories/edit/' . $award_category['id'])); ?>"><i
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/College/KarmaPatro/resources/views/admin/setting/employee_award/award_category/manage_award_category.blade.php ENDPATH**/ ?>