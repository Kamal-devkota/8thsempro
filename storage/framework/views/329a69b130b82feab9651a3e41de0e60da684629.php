...
<?php $__env->startSection('main_content'); ?>
                ...
                <form action="<?php echo e(url('/hrm/leave_application/store')); ?>" method="post" name="add_form_leave_application">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label for="leave_category"><?php echo e(__('Leave Category ')); ?><span
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" name="last_leave_date" class="form-control pull-right"
                                            id="datepicker3">
                                    </div>
                                    <!-- /.input group -->
                                </div>

                                <label for="last_leave_period"><?php echo e(__('Period of Last Leave')); ?> <span
                                        class="text-danger"></span></label>
                                <div
                                    class="form-group<?php echo e($errors->has('last_leave_period') ? ' has-error' : ''); ?> has-feedback">
                                    <input type="text" name="last_leave_period" id="last_leave_period"
                                        class="form-control" value="<?php echo e(old('last_leave_period')); ?>"
                                        placeholder="<?php echo e(__('Enter Period of Last Leave..')); ?>">
                                ...
                                <label for="leave_category"><?php echo e(__('Category of Last Leave')); ?> <span
                                        class="text-danger"></span></label>
                                <div
                                    class="form-group<?php echo e($errors->has('leave_category') ? ' has-error' : ''); ?> has-feedback">
                                ...
                                <label for="leave_address"><?php echo e(__('Leave Address')); ?> <span
                                        class="text-danger"></span></label>
                                <div
                                    class="form-group<?php echo e($errors->has('leave_address') ? ' has-error' : ''); ?> has-feedback">
                            ...
                            <div class="col-md-12">
                                ...
                                <label for="during_leave"><?php echo e(__('Bottom Section')); ?> <span
                                        class="text-danger"></span></label>
                                <div
                                    class="form-group<?php echo e($errors->has('during_leave') ? ' has-error' : ''); ?> has-feedback">
                                    <input type="text" name="during_leave" id="during_leave" class="form-control"
                                        value="<?php echo e(old('during_leave')); ?>"
                                        placeholder="<?php echo e(__('Therefore, I request you to kindly grant me leave for .. Enter here')); ?>">
                    ...
                    <div class="box-footer">
                        <a href="<?php echo e(url('/hrm/leave_application')); ?>" class="btn btn-danger btn-flat"><i
    ...
    <script type="text/javascript">
        document.forms['add_form_leave_application'].elements['publication_status'].value =
            "<?php echo e(old('publication_status')); ?>";
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/College/KarmaPatro/resources/views/admin/hrm/leave_application/add_leave_application.blade.php ENDPATH**/ ?>