                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group<?php echo e($errors->has('client_type_description') ? ' has-error' : ''); ?> has-feedback">
                                <textarea class="textarea text-description" name="client_type_description" id="client_type_description" placeholder="<?php echo e(__('Enter client description..')); ?>"><?php echo e($client_type['client_type_description']); ?></textarea>
                                <?php if($errors->has('client_type')): ?>
                                <span class="help-block">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/College/KarmaPatro/resources/views/admin/setting/client_type/edit_client_type.blade.php ENDPATH**/ ?>