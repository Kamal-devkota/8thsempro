    ...
    <div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="col-md-3">
                        <a href="<?php echo e(url('/employees/create')); ?>" class="btn btn-primary btn-flat"><i
                        ...
                        <table class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center"><?php echo e(__('Created')); ?></th>
                                ...
                                <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?php echo e(date('d F Y', strtotime($employee['created_at']))); ?></td>

                                        <td class="text-center">
                                            <a href="<?php echo e(url('/employees/edit/' . $employee['id'])); ?>"><i
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/College/KarmaPatro/resources/views/admin/employee/index.blade.php ENDPATH**/ ?>