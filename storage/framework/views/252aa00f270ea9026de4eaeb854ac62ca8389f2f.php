    ...
    <div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="col-md-3">
                        <a href="<?php echo e(url('/clients/create')); ?>" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i>
                            <?php echo e(__('Add Customer')); ?></a>
                    </div>
                    <div class="col-md-3">
                            ...
                            <tbody id="myTable">
                                ...
                                <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?php echo e(date('d F Y', strtotime($client['created_at']))); ?>

                                        </td>

                                        <td class="text-center">
                                            <a href="<?php echo e(url('/clients/edit/' . $client['id'])); ?>"><i
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/College/KarmaPatro/resources/views/admin/clients/manage_clients.blade.php ENDPATH**/ ?>