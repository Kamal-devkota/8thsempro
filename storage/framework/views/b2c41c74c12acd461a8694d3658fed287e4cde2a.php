                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group<?php echo e($errors->has('gift_item') ? ' has-error' : ''); ?> has-feedback">
                                    <input type="text" name="gift_item" id="gift_item" class="form-control"
                                        value="<?php echo e(old('gift_item')); ?>" placeholder="<?php echo e(__('Enter Gift Item..')); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" name="select_month" class="form-control pull-right"
                                            id="datepicker">
                                    </div>
                                    <!-- /.input group -->
                                </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/College/KarmaPatro/resources/views/admin/hrm/employee_awards/add_employee_award.blade.php ENDPATH**/ ?>