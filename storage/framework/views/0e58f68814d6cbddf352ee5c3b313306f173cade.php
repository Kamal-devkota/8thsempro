<?php $__env->startSection('title', __('Manage Expense')); ?>
...
<div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <div  class="col-md-3">
                    <a href="<?php echo e(url('/hrm/expense/add-expense')); ?>" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> <?php echo e(__('add new accounts')); ?></a>
                </div>
                <div  class="col-md-3">
                ...
                <table  class="table table-bordered table-striped">
                    ...
                    <tbody id="myTable">
                        ...
                        <tr>
                            ...
                            <?php $empname= \App\Models\User::find($expense->employee_id)->name;?>
                            ...
                            <td><a href="<?php echo e(url('/hrm/expense/payslip/'.$expense->id)); ?>" class="btn btn-primary">Pay Slip</a></td>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/College/KarmaPatro/resources/views/admin/hrm/expense/manage_expense.blade.php ENDPATH**/ ?>