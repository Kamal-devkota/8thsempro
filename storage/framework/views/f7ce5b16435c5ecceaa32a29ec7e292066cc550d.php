                ...
                <div class="box-body">
                    ...
                    <form action="<?php echo e(url('/hrm/attendance/store')); ?>" method="post">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="7"><button type="submit"
                                            class="btn btn-primary btn-flat pull-right"><i class="icon fa fa-save"></i>
                                            <?php echo e(__('Save')); ?></button></td>
                                </tr>
                            </tfoot>
                        </table>
                    </form>
                        ...
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                <div class="modal-header settime">
                                    <h4 class="modal-title"><?php echo e(__('Update Time')); ?> </h4>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/College/KarmaPatro/resources/views/admin/hrm/attendance/set_attendance.blade.php ENDPATH**/ ?>