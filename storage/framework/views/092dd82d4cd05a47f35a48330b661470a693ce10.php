...
<div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo e(url('/employees')); ?>">   <?php echo e(__('Team')); ?></a></li>
    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <!-- /.box-header -->
            <form action="<?php echo e(url('/employees/update/'.$employee['id'])); ?>" method="post" name="employee_edit_form">
                ...
                <div class="box-body">
                    ...
                    <div class="box-footer">
                        <a href="<?php echo e(url('/employees')); ?>" class="btn btn-danger btn-flat"><i class="icon fa fa-close"></i> <?php echo e(__(' Cancel')); ?></a>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/College/KarmaPatro/resources/views/admin/employee/edit.blade.php ENDPATH**/ ?>