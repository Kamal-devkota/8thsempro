    ...
    <div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <!-- /.Notification Box -->
                            <div class="col-md-12">
                                <form class="form-horizontal" name="employee_select_form"
                                    action="<?php echo e(url('/hrm/payroll/go')); ?>" method="post">
                                    <?php echo e(csrf_field()); ?>


                                    <div class="form-group<?php echo e($errors->has('user_id') ? ' has-error' : ''); ?>">
                                        <label for="user_id"
                                            class="col-sm-3 control-label"><?php echo e(__('Employee Name')); ?></label>
                                        <div class="col-sm-6">
                ...
                <form name="employee_salary_form" id="employee_salary_form" action="<?php echo e(url('/hrm/payroll/store')); ?>"
                    method="post">
                    <?php echo e(csrf_field()); ?>
                                ...
                                <div class="box-body">
                                    <div class="form-group<?php echo e($errors->has('employee_type') ? ' has-error' : ''); ?>">
                                        <label for="employee_type"
                                            class="col-sm-3 control-label"><?php echo e(__('Employee Type')); ?></label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group<?php echo e($errors->has('basic_salary') ? ' has-error' : ''); ?>">
                                        <label for="basic_salary"
                                            class="col-sm-3 control-label"><?php echo e(__('Basic Salary')); ?></label>
                                        <div class="col-sm-6">
                                            <input type="number" name="basic_salary" class="form-control" id="basic_salary"
                                                value="<?php echo e(old('basic_salary')); ?>"
                                                placeholder="<?php echo e(__('Enter basic salary..')); ?>">
                            ...
                            <div class="box-body">
                                <div class="form-group<?php echo e($errors->has('house_rent_allowance') ? ' has-error' : ''); ?>">
                                    ...
                                    <input type="number" name="house_rent_allowance"
                                        value="<?php echo e(old('house_rent_allowance')); ?>" class="form-control"
                                        id="house_rent_allowance"
                                        placeholder="<?php echo e(__('Enter house rent allowance..')); ?>">
                                ...
                                <div class="form-group<?php echo e($errors->has('medical_allowance') ? ' has-error' : ''); ?>">
                                    ...
                                    <input type="number" name="medical_allowance"
                                        value="<?php echo e(old('medical_allowance')); ?>" class="form-control"
                                        id="medical_allowance" placeholder="<?php echo e(__('Enter medical allowance..')); ?>">
                                ...
                                <div class="form-group<?php echo e($errors->has('special_allowance') ? ' has-error' : ''); ?>">
                                    ...
                                    <input type="number" name="special_allowance"
                                        value="<?php echo e(old('special_allowance')); ?>" class="form-control"
                                        id="special_allowance" placeholder="<?php echo e(__('Enter special allowance..')); ?>">
                                ...
                                <div
                                    class="form-group<?php echo e($errors->has('provident_fund_contribution') ? ' has-error' : ''); ?>">
                                    <label
                                        for="provident_fund_contribution"><?php echo e(__('Provident Fund Contribution')); ?></label>
                                    <input type="number" name="provident_fund_contribution"
                                        value="<?php echo e(old('provident_fund_contribution')); ?>" class="form-control"
                                        id="provident_fund_contribution"
                                        placeholder="<?php echo e(__('Enter provident fund contribution..')); ?>">
                                ...
                                <div class="form-group<?php echo e($errors->has('other_allowance') ? ' has-error' : ''); ?>">
                                    ...
                                    <input type="number" name="other_allowance" value="<?php echo e(old('other_allowance')); ?>"
                                        class="form-control" id="other_allowance"
                                        placeholder="<?php echo e(__('Enter other allowance..')); ?>">
                        ...
                        <div class="box box-warning">
                            ...
                            <div class="box-body">
                                <div class="form-group<?php echo e($errors->has('tax_deduction') ? ' has-error' : ''); ?>">
                                    ...
                                    <input type="number" name="tax_deduction" value="<?php echo e(old('tax_deduction')); ?>"
                                        class="form-control" id="tax_deduction"
                                        placeholder="<?php echo e(__('Enter tax deduction..')); ?>">
                                ...
                                <div
                                    class="form-group<?php echo e($errors->has('provident_fund_deduction') ? ' has-error' : ''); ?>">
                                    <label for="provident_fund_deduction"><?php echo e(__('Provident Fund Deduction')); ?></label>
                                    <input type="number" name="provident_fund_deduction"
                                        value="<?php echo e(old('provident_fund_deduction')); ?>" class="form-control"
                                        id="provident_fund_deduction"
                                        placeholder="<?php echo e(__('Enter provident fund deduction..')); ?>">
                                ...
                                <div class="form-group<?php echo e($errors->has('other_deduction') ? ' has-error' : ''); ?>">
                                    ...
                                    <input type="number" name="other_deduction" value="<?php echo e(old('other_deduction')); ?>"
                                        class="form-control" id="other_deduction"
                                        placeholder="<?php echo e(__('Enter other deduction..')); ?>">
                        ...
                        <div class="box box-danger">
                            ...
                            <div class="box-footer">
                                <button type="submit" class="btn btn-primary btn-flat pull-right"><i
                                        class="fa fa-save"></i> <?php echo e(__('Save Details')); ?></button>
                            </div>
                        </div>
                    </div>
                    <!-- /.end.col -->
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/College/KarmaPatro/resources/views/admin/hrm/payroll/create_salary.blade.php ENDPATH**/ ?>