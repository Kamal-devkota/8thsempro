...
==================================================-->
    <section id="payslip_new">
        <div class="container">
           ...
           <?php $expenses=\App\Models\ExpenseManagement::all()->where('id', $id);?>
                ...
                <div class="col-lg-12 header_main clear-fix">
                    ...
                    <div class="brand_logo">
                       ...
                       <?php if(!empty(auth()->user()->avatar)): ?>
                        <img src="<?php echo e(asset('public/profile_picture/'.auth()->user()->avatar)); ?>" class="receiptlogo" alt="User Image">
                        <?php else: ?>
                        <img src="<?php echo e(asset('public/profile_picture/blank_profile_picture.png')); ?>" class="receiptlogo" alt="User Image">
                        <?php endif; ?>
                    </div>


                    <div class="Pay_slip_header_tilte"><span>Pay Slip</span>
                        <p><?php echo e($expense->purchased_date); ?></p>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="Employee_details_table">
                        <table class="table border_less">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>: #<?php echo e(__('EXP')); ?><?php echo e($expense->id); ?></td>
                                </tr>
                                <tr>
                                    <th scope="row"><?php echo e(__('Employee')); ?></th>
                                    <td>: <?php echo e(\App\Models\User::find($expense->employee_id)->name); ?></td>
                                </tr>
                                <tr>
                        ...
                        <table class="table border_less">
                            <tbody>
                                <tr>
                                    <th scope="row"><?php echo e(__('Cheque No')); ?></th>
                                    <td>: <?php if($expense->purchased_from==NULL): ?> None <?php else: ?> <?php echo e($expense->purchased_from); ?> <?php endif; ?></td>
                                </tr>
                                <tr>
                                    <th scope="row"><?php echo e(__('Pay By Email')); ?></th>
                                    <td>: <?php echo e(Auth::user()->email); ?></td>
                                </tr>
                                <tr>
                                    <th scope="row"><?php echo e(__('Pay By Number')); ?> :</th>
                                    <td>: <?php echo e(Auth::user()->contact_no_one); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                       <table class="table">
                            <thead>
                                <tr>
                                    <th scope="col"><?php echo e(__('S/L')); ?><span class="Null_text">__</span></th>
                                    <th scope="col"><?php echo e(__('Purpose')); ?><span class="Null_text">__</span></th>
                                    <th scope="col"><?php echo e(__('Particular')); ?></th>
                                    <th scope="col" class="text-right"><?php echo e(__('Amount')); ?></th>
                                </tr>
                            </thead>
                             <tr>
                                    <td scope="col">1<span class="Null_text">__</span></td>
                                    <td scope="col"><?php echo e($expense->item_name); ?><span class="Null_text">__</span></td>
                                    <td scope="col"><?php echo e($expense->purchased_details); ?></td>
                                    <td scope="col" class="text-right">$<?php echo e($expense->amount_spent); ?>.00</td>
                                </tr>
                        </table>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col"><span class="Null_text">__</span></th>
                                    <th scope="col"><?php echo e(__('Net Pay')); ?></th>
                                    <th scope="col">$<?php echo e($expense->amount_spent); ?>.00</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
         ...
         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
            <div class="row">
                <div class="col-lg-12">
                    <div class="Signature_container">
                        ...
                        <div class="Employer_sign">
                            <div class="act_signature">
                                <h4><?php echo e(__('Employee\'s Signature')); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
             ...
             <div class="myprint">
                    <button class="btn btn-primary" onclick="window.print()" ><i  class="fa fa-print"></i> <?php echo e(__('Print')); ?></button>
                    <a href="<?php echo e(url('hrm/expense/manage-expense')); ?>"><button class="btn btn-primary"><i class="fa fa-download"></i> <?php echo e(__('Back')); ?></button></a>
...
<?php /**PATH /var/www/html/College/KarmaPatro/resources/views/admin/hrm/expense/ExpensePayslip.blade.php ENDPATH**/ ?>