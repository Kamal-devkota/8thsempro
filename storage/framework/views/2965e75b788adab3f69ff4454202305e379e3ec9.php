...
<div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <!-- /.box-header -->
            <form action="<?php echo e(url('/setting/departments/update/'. $department['id'])); ?>" method="post" name="department_edit_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo e($errors->has('department') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="department" id="department" class="form-control" value="<?php echo e($department['department']); ?>" placeholder="<?php echo e(__('Enter department name..')); ?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group<?php echo e($errors->has('department_description') ? ' has-error' : ''); ?> has-feedback">
                                <textarea class="textarea text-description" name="department_description" id="department_description" placeholder="<?php echo e(__('Enter description..')); ?>"><?php echo e($department['department_description']); ?></textarea>
                                <?php if($errors->has('department')): ?>
                                <span class="help-block">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-edit"></i> <?php echo e(__('Update department')); ?></button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/College/KarmaPatro/resources/views/admin/setting/department/edit.blade.php ENDPATH**/ ?>