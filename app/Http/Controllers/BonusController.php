...
class BonusController extends Controller
{
    ...
    public function index()
    {
        $bonuses = Bonus::query()
            ...
            ->toArray();
        return view('admin.hrm.bonus.manage_bonuses', compact('bonuses'));
    }
    ...
    public function create()
    {
        $users = User::where('deletion_status', 0)
            ...
            ->get()
            ->toArray();
        return view('admin.hrm.bonus.add_bonus', compact('users'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.hrm.bonus.show_bonus', compact('bonus', 'users'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.hrm.bonus.edit_bonus', compact('bonus', 'users'));
    }
