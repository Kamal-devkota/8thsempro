...
class LoanController extends Controller
{
    ...
    public function index()
    {
        $loans = Loan::query()
            ...
            ->toArray();
        return view('admin.hrm.loan.manage_loans', compact('loans'));
    }
    ...
    public function create()
    {
        $users = User::where('deletion_status', 0)
            ...
            ->get()
            ->toArray();
        return view('admin.hrm.loan.add_loan', compact('users'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.hrm.loan.show_loan', compact('loan', 'users'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.hrm.loan.edit_loan', compact('loan', 'users'));
    }
