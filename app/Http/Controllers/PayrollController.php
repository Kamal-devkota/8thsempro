...
class PayrollController extends Controller
{
    public function index() {
		...
		return view('admin.hrm.payroll.manage_salary', compact('employees'));
	}
	...
	public function create($user_id) {
		...
		if (!empty($salary)) {
			return view('admin.hrm.payroll.edit_salary', compact('employees', 'employee_id', 'salary'));
		} else {
			return view('admin.hrm.payroll.create_salary', compact('employees', 'employee_id'));
		}
	}
	...
	public function list() {
		$salaries = Payroll::query()
			...
			->toArray();
		return view('admin.hrm.payroll.salary_list', compact('salaries'));
	}
	...
	public function show($id) {
		$salary = Payroll::query()
			...
			->toArray();
		return view('admin.hrm.payroll.salary_details', compact('salary'));
	}
