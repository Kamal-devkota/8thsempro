...
class CustomerTypeController extends Controller
{
    ...
    public function index()
    {
        $client_types = ClientType::all()
            ...
            ->toArray();
        return view('admin.setting.client_type.manage_client_types', compact('client_types'));
    }
    ...
    {
        return view('admin.setting.client_type.add_client_type');
    }
    ...
    public function show($id)
    {
        $client_type = DB::table('client_types')
            ...
            ->first();
        return view('admin.setting.client_type.show_client_type', compact('client_type'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.setting.client_type.edit_client_type', compact('client_type'));
    }
