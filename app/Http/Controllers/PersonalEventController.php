...
class PersonalEventController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.setting.personal_event.manage_personal_events', compact('personal_events'));
    }
    ...
    {
        return view('admin.setting.personal_event.add_personal_event');
    }
    ...
    public function show($id)
    {
        $personal_event = PersonalEvent::query()
            ...
            ->toArray();
        return view('admin.setting.personal_event.show_personal_event', compact('personal_event'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.setting.personal_event.edit_personal_event', compact('personal_event'));
    }
