...
class AwardCategoryController extends Controller
{
    ...
    public function index()
    {
        $award_categorys = AwardCategory::query()
            ...
            ->toArray();
        return view('admin.setting.employee_award.award_category.manage_award_category', compact('award_categorys'));
    }
    ...
    {
        return view('admin.setting.employee_award.award_category.add_award_category');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.setting.employee_award.award_category.edit_award_category', compact('award_categorys'));
    }
