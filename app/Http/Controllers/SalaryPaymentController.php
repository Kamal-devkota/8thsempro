...
use App\Models\User;
use App\Models\SalaryPaymentDetails;
...
class SalaryPaymentController extends Controller
{
    ...
    public function index()
    {
        $employees = Payroll::query()
            ...
            ->toArray();
        return view('admin.hrm.salary_payment.manage_payment', compact('employees'));
    }
    /**
    ...
    public function create($user_id, $salary_month)
    {
        ...
        if (!empty($salary_payment)) {
            ...
            return view('admin.hrm.salary_payment.salary_payment_details', compact('user_id', 'salary_month', 'user', 'employee_salaries', 'salary_payment_details', 'salary_payment'));
        }
        return view('admin.hrm.salary_payment.make_salary', compact('salary', 'bonuses', 'deductions', 'loans', 'user_id', 'salary_month', 'user'));
    }
    public function pdf($user_id, $salary_month)
    {
        ...
        if (!empty($salary_payment)) {
            $salary_payment_details = SalaryPaymentDetails::where('salary_payment_id', $salary_payment->id)->get();
            $pdf = PDF::loadView('admin.hrm.salary_payment.pdf', compact('user_id', 'salary_month', 'user', 'employee_salaries', 'salary_payment_details', 'salary_payment'));
    ...
    {
        return view('admin.hrm.salary_payment.generate_payslip');
    }
    /**
     * Store a newly created resource in storage.
     *
    ...
    {
        return view('admin.hrm.salary_payment.salarySheetSearch');
    }
    /**
     * Store a newly created resource in storage.
     *
    ...
    public function salarySheetView(Request $request)
    {
        ...
        return view('admin.hrm.salary_payment.salarySheetView', compact('salary_month'));
    }
    /**
     * Display a listing of the resource.
     *
    ...
    public function list($salary_month)
    {
        ...
        $salary_payments = SalaryPayment::whereYear('payment_month', '=', $year)
            ...
            ->get(['user_id'])
            ->toarray();
        return view('admin.hrm.salary_payment.employees_salary_list', compact('employees', 'salary_month', 'bonuses', 'deductions', 'loans', 'salary_payments'));
    }
    /**
     * Display the specified resource.
     *
    ...
    public function provident_fund()
    {
        ...
        $provident_funds = DB::table('salary_payments')
            ...
            ->get();
        return view('admin.hrm.provident_fund.provident_funds', compact('employees', 'provident_funds'));
    }
}
