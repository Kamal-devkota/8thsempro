...
class LeaveAppController extends Controller
{
	public function reports()
	{
		...
		return view('admin.hrm.leave_application.leave_report', compact('users', 'attendances', 'casual_leaves', 'earned_leaves', 'earned_leaves', 'advance_leaves', 'special_leaves', 'absences'));
	}
	...
	public function pdf_reports()
	{
		...
		$pdf = PDF::loadView('admin.hrm.leave_application.pdf_reports', compact('users', 'attendances', 'casual_leaves', 'earned_leaves', 'earned_leaves', 'advance_leaves', 'special_leaves', 'absences'));
	...
	public function index()
	{
		...
		return view('admin.hrm.leave_application.manage_application', compact('leave_applications'));
	}
	...
	public function apllicationLists()
	{
		$leave_applications = LeaveApplication::query()
			...
			->toArray();
		return view('admin.hrm.leave_application.manage_application_lists', compact('leave_applications'));
	}

	public function applicationDownload($id)
	{
		return view('admin.hrm.leave_application.applicationDownload', compact('id'));
	}
	...
	public function create()
	{
		$leave_categorys = LeaveCategory::where('deletion_status', 0)
			...
			->get();
		return view('admin.hrm.leave_application.add_leave_application', compact('leave_categorys'));
	}
	...
	public function show($id)
	{
		$leave_application = LeaveApplication::query()
			...
			->toArray();
		return view('admin.hrm.leave_application.show_leave_application', compact('leave_application'));
	}
