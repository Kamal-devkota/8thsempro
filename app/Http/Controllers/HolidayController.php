...
class HolidayController extends Controller
{
    ...
    public function index()
    {
        $holidays = Holiday::query()
            ...
            ->toArray();
        return view('admin.setting.holiday.manage-holidays', compact('holidays'));
    }
    ...
    {
        return view('admin.setting.holiday.add-holidays');
    }
    ...
    public function show($id)
    {
        ...
        $holidays = Holiday::query()
            ...
            ->toArray();
        return view('admin.setting.holiday.show-holidays', compact('holidays'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.setting.holiday.edit-holidays', compact('holidays'));
    }
