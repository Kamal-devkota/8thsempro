...
class CustomerController extends Controller
{
    ...
    public function index()
    {
        $clients = User::query()
            ...
            ->get()
            ->toArray();
        return view('admin.clients.manage_clients', compact('clients'));
    }
    ...
    public function print()
    {
        $clients = User::query()
            ...
            ->get()
            ->toArray();
        return view('admin.clients.clients_print', compact('clients'));
    }
    ...
    public function clients_pdf()
    {
        ...
        $pdf = PDF::loadView('admin.clients.clients_pdf', compact('clients'));
    ...
    public function create()
    {
        ...
        $designations = Designation::where('deletion_status', 0)
            ...
            ->get()
            ->toArray();
        return view('admin.clients.add_client', compact('client_types', 'designations'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!empty($inserted_id)) {
            return redirect('/clients/create')->with('message', 'Add successfully.');
        }
        return redirect('/clients/create')->with('exception', 'Operation failed !');
    }
    ...
    public function active($id)
    {
        ...
        if (!empty($affected_row)) {
            return redirect('/clients')->with('message', 'Activate successfully.');
        }
        return redirect('/clients')->with('exception', 'Operation failed !');
    }
    ...
    public function deactive($id)
    {
        ...
        if (!empty($affected_row)) {
            return redirect('/clients')->with('message', 'Deactive successfully.');
        }
        return redirect('/clients')->with('exception', 'Operation failed !');
    }
    ...
    public function show($id)
    {
        ...
        $created_by = User::where('id', $client->created_by)
            ->select('id', 'name')
            ->first();
        return view('admin.clients.show_client', compact('client', 'created_by'));
    }
    ...
    public function pdf($id)
    {
        ...
        $pdf = PDF::loadView('admin.clients.pdf', compact('client', 'created_by'));
    ...
    public function edit($id)
    {
        ...
        $designations = Designation::where('deletion_status', 0)
            ...
            ->get()
            ->toArray();
        return view('admin.clients.edit_client', compact('client', 'client_types', 'designations'));
    }
    ...
    public function destroy($id)
    {
        ...
        if (!empty($affected_row)) {
            return redirect('/clients')->with('message', 'Delete successfully.');
        }
        return redirect('/clients')->with('exception', 'Operation failed !');
    }
}
