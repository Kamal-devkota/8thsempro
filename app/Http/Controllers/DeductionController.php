...
class DeductionController extends Controller
{
    ...
    public function index()
    {
        $deductions = Deduction::query()
            ...
            ->toArray();
        return view('admin.hrm.deduction.manage_deductions', compact('deductions'));
    }
    ...
    public function create()
    {
        $users = User::where('deletion_status', 0)
            ...
            ->get()
            ->toArray();
        return view('admin.hrm.deduction.add_deduction', compact('users'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.hrm.deduction.show_deduction', compact('deduction', 'users'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.hrm.deduction.edit_deduction', compact('deduction', 'users'));
    }
